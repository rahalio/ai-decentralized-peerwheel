 ...
 *
 * @returns The core table name (e.g., "peerwheel-core-dev")
 ...
 *
 * @returns The base table name (e.g., "peerwheel-base-dev")
 ...
 *
 * @returns The analytics table name (e.g., "peerwheel-analytics-dev")
 ...
 *
 * @returns The realtime table name (e.g., "peerwheel-app-realtime-dev")
