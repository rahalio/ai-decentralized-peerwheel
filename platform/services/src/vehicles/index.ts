/**
 * Vehicles Services - Application Layer Export
 *
...
/**
 * Vehicles Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for vehicles domain.
 */
