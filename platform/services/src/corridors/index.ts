/**
 * Corridors Services - Application Layer Export
 *
...
/**
 * Corridors Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for corridors domain.
 */
