...
const DOMAIN_PATH_PATTERNS: Array<{ pattern: RegExp; domain: string }> = [
  ...
  { pattern: /\/canvas\//, domain: "canvas" },
  { pattern: /\/corridors\//, domain: "corridors" },
  { pattern: /\/disputes\//, domain: "disputes" },
  { pattern: /\/identity\//, domain: "identity" },
  { pattern: /\/rides\//, domain: "rides" },
  { pattern: /\/settlements\//, domain: "settlements" },
  { pattern: /\/vehicles\//, domain: "vehicles" },
];
  ...
  if (!domainDeps) {
    ...
    switch (domain) {
      case "attestations":
        ...
        break;
      case "canvas":
        domainDeps = buildCanvasDomainModule(dynamoClient);
        break;
      case "corridors":
        domainDeps = buildCorridorsDomainModule(dynamoClient);
        break;
      case "disputes":
      ...
      case "identity":
        ...
        break;
      case "rides":
        domainDeps = buildRidesDomainModule(dynamoClient);
        break;
      case "settlements":
        domainDeps = buildSettlementsDomainModule(dynamoClient);
        break;
      case "vehicles":
        domainDeps = buildVehiclesDomainModule(dynamoClient);
        break;
      default:
        return;
    }
...
export interface DomainDependencies {
  ...
  canvas: CanvasDomainModule;
  corridors: CorridorsDomainModule;
  disputes: DisputesDomainModule;
  identity: IdentityDomainModule;
  rides: RidesDomainModule;
  settlements: SettlementsDomainModule;
  vehicles: VehiclesDomainModule;
}
...
export function getCanvasDeps(
  request: FastifyRequest,
): DomainDependencies["canvas"] {
  return getDomainDeps(request, "canvas");
}
export function getCorridorsDeps(
  request: FastifyRequest,
): DomainDependencies["corridors"] {
  return getDomainDeps(request, "corridors");
}
...
export function getRidesDeps(
  request: FastifyRequest,
): DomainDependencies["rides"] {
  return getDomainDeps(request, "rides");
}
...
export function getVehiclesDeps(
  request: FastifyRequest,
): DomainDependencies["vehicles"] {
  return getDomainDeps(request, "vehicles");
}
