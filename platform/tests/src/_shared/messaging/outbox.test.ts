...
import { DynamoDbOutboxStore } from "@peerwheel/adapters/_shared/messaging/dynamodb-outbox-store.js";
import { startOutboxWorker } from "@peerwheel/adapters/_shared/messaging/outbox-worker.js";
import { createInProcessIntegrationEventBus } from "@peerwheel/adapters/_shared/messaging/in-process-integration-event-bus.js";
